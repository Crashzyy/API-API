    ...
    public function run(): void
    {
        $alat = [
            ...
            [
                ...
                'stok' => 8,
                'status_kondisi' => 'Baik',
                'deskripsi' => 'Perangkar komputasi ringkas untuk server',
            ...
            [
                ...
                'stok' => 20,
                'status_kondisi' => 'Baik',
                'deskripsi' => 'Alat potong dan pasang konekter kabel UTP',
                'gambar' => 'crimping_proskit.jpg'
            ],
            [
                'kategori_id' => 5,
                'nama_alat' => 'Adapter HDMI to VGA with Audio',
                'stok' => 25,
                'status_kondisi' => 'Baik',
                'deskripsi' => 'Konverter display untuk menyambungkan perangkat modern ke proyekter lama',
                'gambar' => 'hdmi_vga.jpg'
            ],
        ];
