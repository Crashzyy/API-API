...
class LogAktivitasSeeder extends Seeder
{
    public function run(): void
    {
        $logs = [
            ...
            ['user_id' => 4, 'aktivitas' => 'Memproses pengembalian alat telat untuk peminjaman ID #3 dan mengenakan denda.'],
            ['user_id' => 5, 'aktivitas' => 'Mengubah konfigurasi hak akses aplikasi.'],
        ];
