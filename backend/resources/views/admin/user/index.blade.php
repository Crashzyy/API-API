...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        <div class="p-5 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3 w-full nd:w-auto">
                <form action="{{ route('admin.user.index') }}" method="GET" class="flex w-full nd:w-80">
            ...
            <a href="{{ route('admin.user.create')}}" class="bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition">
            + Tambah User </a>
        </div>
                    ...
                    @forelse($users as $user)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-4 border-b">
                                ...
                                <!-- Tombol Edit -->
                                    <a href="{{ route('admin.user.edit', $user->id) }}" class="bg-amber-500 hover:bg-amber-600 text-white px-3 py-1.5 rounded text-xs font-senibold transition"> Edit </a>
