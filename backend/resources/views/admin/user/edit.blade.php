    ...
    <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name', $user->name) }}" required 
                class="w-full px-3 py-2 border border-gray-300 rounde-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        ...
        <div class="flex justify-end space-x-2">
            ...
            class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg text-sm font-semibold">batal</a>
            <button type="submit"
